...
def parse_args():
    ...
    parser.add_argument("--data_path", required=False,
                        help="Path to data", default='/home/long/Desktop/Liveness-Detection-ZaloAIChallenge/final_train/train')
    parser.add_argument("--test_data_path_to_save", required=False,
                        help="Path to test data where to save", default='/home/long/Desktop/Liveness-Detection-ZaloAIChallenge/final_train/val')
